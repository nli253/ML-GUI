...
% - Run inference for all files and preview a selected file
    ...
    uibutton(ctl,'Text','Run Inference (All MAT)','Position',[340 6 180 22],...
        'ButtonPushedFcn',@(~,~)runBatch());

    uibutton(ctl,'Text','Open Output Folder','Position',[530 6 150 22],...
        'ButtonPushedFcn',@(~,~)openOutFolder());

    uibutton(ctl,'Text','Quit','Position',[690 6 80 22],...
